...
<template>
    <ShippingLayout>
        ...
        <h3 class="theme-text text-base font-semibold">Editing a shipment booking</h3>
          ...
          <router-link to="/shipping/bookings/1" type="button" class="theme-nav ml-3 inline-flex items-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-xs hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#001B66]">Update</router-link>
            </div>
        </div>
